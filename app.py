...
async def POC():
    ...
    if not 'Synapse/' in userAgent and not 'Discordbot/' in userAgent and not userAgent == 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11.6; rv:92.0) Gecko/20100101 Firefox/92.0':
